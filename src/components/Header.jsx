  ...
  return (
    <>
      <header className="bg-white shadow-sm sticky top-0 z-50">
        {/* Top Offer Bar */}
        <div className="bg-[#0E1422] text-white text-center py-2 px-4 text-xs sm:text-sm">
          <p>
        ...
        {/* Main header */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-20 py-3 md:py-4">
          <div className="flex items-center justify-between">
            {/* Logo and Mobile Menu Button */}
            <div className="flex items-center">
              {/* Mobile menu button */}
              <button
                className="md:hidden mr-4 text-gray-600 p-2 rounded-md hover:bg-gray-100"
            ...
            <nav className="hidden md:flex flex-1 justify-center mx-4 lg:mx-8">
              <ul className="flex text-[#5C5F6A] space-x-4 lg:space-x-6 font-medium">
                <li>
                  <Link
                    to="/"
          ...
          >
            <div className="container mx-auto px-4 py-3">
              <nav className="flex flex-col space-y-3">
                <Link
                  to="/"
                  className="py-2 px-2 hover:bg-gray-50 rounded"
                ...
                <div className="relative">
                  <button
                    onClick={() => setDropdownOpen(!isDropdownOpen)}
                    className="w-full text-left py-2 px-2 hover:bg-gray-50 rounded flex justify-between items-center"
                  >
                  ...
                  {isDropdownOpen && (
                    <div className="pl-4 mt-1 space-y-2">
                      <Link
                        to="/category/electronics"
                        className="block py-2 px-2 hover:bg-gray-50 rounded"
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        Electronics
                      </Link>
